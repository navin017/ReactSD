...
const CreateStudents = (handleClose) => {
  ...
  const [enterInputTwo,setEnterInputTwo] = useState(true)
  const [email, setEmail] = useState("");
  const [enterEmail,setEnterEmail] = useState(true)
  const [tamil, setTamil] = useState("");
  const [enterTamil,setEnterTamil] = useState(true)
  const [english, setEnglish] = useState("");
  const [enterEnglish,setEnterEnglish] = useState(true)
  const [maths, setMaths] = useState("");
  const [enterMaths,setEnterMaths] = useState(true)
    ...
    <form onSubmit={submitHandler}>
      ...
      <div className='total'>
        <table className='cover'>
          ...
          <button type='submit' onClick={handlerClose}>CLOSE</button>
        </table>
      </div>
